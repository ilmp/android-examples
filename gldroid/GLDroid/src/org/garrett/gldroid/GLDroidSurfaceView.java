...
public class GLDroidSurfaceView extends GLSurfaceView {
	private final float TOUCH_SCALE_FACTOR = 180.0f / 320;
	
	private float oldX, oldY;
	GLDroidRenderer renderer;
	
	public GLDroidSurfaceView(Context context){
		super(context);
		...
		// set renderer
		renderer = new GLDroidRenderer(context);
